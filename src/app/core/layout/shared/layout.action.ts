...
export const OPEN_QUICKDETAIL =   '[Layout] Open QuickDetail';
export const CLOSE_QUICKDETAIL =  '[Layout] Close QuickDetail';
export const TOGGLE_QUICKDETAIL =  '[Layout] Toggle QuickDetail';
...
export class OpenQuickDetailAction implements Action {
  readonly type = OPEN_QUICKDETAIL;
}

export class CloseQuickDetailAction implements Action {
  readonly type = CLOSE_QUICKDETAIL;
}

export class ToggleQuickDetailAction implements Action {
  readonly type = TOGGLE_QUICKDETAIL;
}
...
export type Actions
  ...
  | OpenQuickDetailAction
  | CloseQuickDetailAction
  | ToggleQuickDetailAction
